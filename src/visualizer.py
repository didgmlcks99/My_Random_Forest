...
def plot_graph(name):
    ...
    with open(name, mode = 'r') as file:
        ...
        for lines in csvFile:
            ...
            tp.append(float(lines[4]))
            fn.append(float(lines[5]))
            fp.append(float(lines[6]))
            tn.append(float(lines[7]))

            accuracy.append(float(lines[8])*100)
            precision.append(float(lines[9])*100)
            recall.append(float(lines[10])*100)
